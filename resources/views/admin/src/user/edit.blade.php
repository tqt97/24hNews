...
@section('content')
    <div class="content">
        @include('admin.layouts.partials.header',[$title = 'Cập nhật thông tin Admin', $current_page = 'Cập nhật'])
                        ...
                        <form action="{{ route('admin.user.update', $user->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Tên người dùng <code>*</code> :</label>
                                            <input type="text" name="name"
                                                class="form-control @error('name') is-invalid @enderror"
                                                value="{{ $user->name }}" placeholder="Điền tên người dùng" autofocus
                                                required>
                                            @error('name')
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Mật khẩu <code>*</code> :</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nhập lại mật khẩu <code>*</code> :</label>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="my-3">
                                                <img src="{{ $user->image ? $user->imageUrl() : '' }}"
                                                    class="imageThumb" />
                                            </div>
                                        </div>
                                    </div>
